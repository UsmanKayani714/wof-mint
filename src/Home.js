...
const Home = ({ connecctstatus, setConnectedstatus }) => {
	...
	async function Mint() {
		...
		let merkel = await axios.post(
			"https://gold-captains.herokuapp.com/api/getWhitelistMerkel",
			{
				senderAddress: address.toString(),
			}
		);
		console.log(merkel.data);

		await contract.methods
			.whiteListMint(merkel.data.merkleProof, quantity)
