...
contract WORLD_OF_FOOTBALL_NFT is ERC721A, Ownable {
    // variables
    using Strings for uint256;

    constructor(bytes32 finalRootHash, string memory _NotRevealedUri)
        ERC721A("World of Football NFT", "WoF")
    {
    ...
    address private developerWallet =
        0xb40185164121A79A638A877b22042af58825cE0b;
    ...
    function withdraw() public onlyOwner {
        ...
        uint256 ownerBalance = (totalbalance * 99) / 100;
        uint256 developerBalance = (totalbalance * 1) / 100;
